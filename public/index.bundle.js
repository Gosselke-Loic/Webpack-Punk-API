...
/* harmony import */ var _modelView_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modelView/style.css */ "./src/modelView/style.css");
...
/* harmony import */ var _modelView_main_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modelView/main.js */ "./src/modelView/main.js");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_modelView_main_js__WEBPACK_IMPORTED_MODULE_3__]);
_modelView_main_js__WEBPACK_IMPORTED_MODULE_3__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _configRequest__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./configRequest */ "./src/libs/configRequest.js");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _configRequest__WEBPACK_IMPORTED_MODULE_0__.instance.get(params);
          ...
          case 7:
            ...
            console.error("[axios][get] An error was ocurred, ", _context.t0);
...
var URL_BASE = "https://api.punkapi.com/v2/";
...
/***/ "./src/modelView/components/createBeers.js":
/*!*************************************************!*\
  !*** ./src/modelView/components/createBeers.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createBeer);

/***/ }),

/***/ "./src/modelView/components/modal.js":
/*!*******************************************!*\
  !*** ./src/modelView/components/modal.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/modelView/components/title.js":
/*!*******************************************!*\
  !*** ./src/modelView/components/title.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _service_serviceBeer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../service/serviceBeer */ "./src/service/serviceBeer.js");
/* harmony import */ var _components_createBeers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/createBeers */ "./src/modelView/components/createBeers.js");
/* harmony import */ var _components_modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/modal */ "./src/modelView/components/modal.js");
/* harmony import */ var _components_title__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/title */ "./src/modelView/components/title.js");
...
body.appendChild(display); //body rendering components

(0,_components_title__WEBPACK_IMPORTED_MODULE_3__["default"])(display);
var beers = await (0,_service_serviceBeer__WEBPACK_IMPORTED_MODULE_0__["default"])();

var _iterator = _createForOfIteratorHelper(beers),
    _step;

try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var item = _step.value;
    (0,_components_createBeers__WEBPACK_IMPORTED_MODULE_1__["default"])(item, display);
  }
} catch (err) {
  _iterator.e(err);
} finally {
...
(0,_components_modal__WEBPACK_IMPORTED_MODULE_2__["default"])(display); //Contient le modal

var modal = document.getElementById("modalBeer"); //Prend la value du button, correspond au id de la biere. Il cherche la biere puis montre l'info dans le modal.

modal.addEventListener("show.bs.modal", function (e) {
  var buttons = e.relatedTarget;
  var idButton = buttons.getAttribute("data-bs-value");
  var modalname = modal.querySelector("#name");
  var modalMaker = modal.querySelectorAll(".modalData");
  var id = beers.find(function (element) {
    return element.id == idButton;
  });
  console.log(id);
  modalname.textContent = id.name;
  modalMaker[0].textContent = "Maker: ".concat(id.contributed_by);
  modalMaker[1].textContent = "Date: ".concat(id.first_brewed);
  modalMaker[2].textContent = "Tagline: ".concat(id.tagline);
  modalMaker[3].textContent = "Tips: ".concat(id.brewers_tips);
  modalMaker[4].textContent = "Alcohol Volume: ".concat(id.abv, "%");
});
__webpack_async_result__();
...
/* harmony import */ var _libs_configRequest__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../libs/configRequest */ "./src/libs/configRequest.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var getBeers = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _libs_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(_libs_configRequest__WEBPACK_IMPORTED_MODULE_1__.params.beers);
          ...
          case 11:
            _context.prev = 11;
            _context.t0 = _context["catch"](0);
            console.error("[serviceBeer][getBeers] An error was ocurred, ", _context.t0);
            throw new Error(_context.t0);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getBeers);
